  ...
  return (
    <div
      className={`items-center h-[${height}px] pl-4 pr-3 text-[14pt] w-[268px] font-regular rounded-[8px]
        ${
          isDisabled
            ? 'bg-grayscale-800 text-grayscale-600'
            : !text
              ? 'bg-grayscale-800 border-grayscale-700 text-grayscale-400 border-[1.5px] hover:border-accentT-20 '
              : isError
                ? 'bg-primaryT-5 border-primaryT-20 text-grayscale-50 border-[1.5px]'
                : isFocused
                  ? 'bg-accentT-5 border-accentT-20 text-grayscale-50 border-[1.5px]'
                  : 'bg-grayscale-800 border-grayscale-700 text-grayscale-50 border-[1.5px] hover:border-accentT-20 '
        }`}
    >
