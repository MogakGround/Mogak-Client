...
const WORK_HOUR_FILTERS: { workHour: WorkHours; label: string; description: string }[] = [
  { workHour: 'LATE_NIGHT', label: getNameByWorkTimeId('LATE_NIGHT'), description: getDescriptionByWorkTimeId('LATE_NIGHT') },
  { workHour: 'MORNING', label: getNameByWorkTimeId('MORNING'), description: getDescriptionByWorkTimeId('MORNING') },
  { workHour: 'AFTERNOON', label: getNameByWorkTimeId('AFTERNOON'), description: getDescriptionByWorkTimeId('AFTERNOON') },
